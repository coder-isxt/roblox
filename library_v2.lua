...
function Window:CreatePlayersCategory(options)
    ...
    local function playPunchAnimation()
        ...
        pcall(function()
            track.Looped = false
            track:Play(0.06, 1, punchAnimationSpeed)
        end)

        task.delay(punchAnimationVisibleTime, function()
    ...
    setPunchFlingEnabled = function(state, silent)
        ...
        if punchFlingEnabled then
            ...
            punchFlingConnection = mouse.Button1Down:Connect(function()
                ...
                punchFlingCooldownUntil = os.clock() + 1.8
